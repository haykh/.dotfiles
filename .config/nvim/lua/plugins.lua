    ...
    require('formatter').setup({
      filetype = {
        ...
        fortran = {function()
          return {
            exe = "fprettify",
            args = {"-i 2", "-w 4", "--whitespace-assignment true", "--enable-decl --whitespace-decl true",
            "--whitespace-relational true", "--whitespace-logical true",
            "--whitespace-plusminus true", "--whitespace-multdiv true", "--whitespace-print true",
            "--whitespace-type true", "--whitespace-intrinsics true", "--enable-replacements",
            "-l 1000"},
            stdin = 1
          }
        end},
...
config = function()
  ...
  config = function()
    ...
    require("nvim-treesitter.configs").setup({
      ensure_installed = {"c", "cpp", "cmake", "glsl", 
      "make", "python", "lua", "rust", 
      "fortran", "go", "gomod",
      "javascript", "css", "html", "json", 
      "yaml", "toml", "bash", "comment", "markdown",
      "markdown_inline", "nasm"},
      highlight = {
        enable = true,
        disable = {'vimdoc'}
      }
